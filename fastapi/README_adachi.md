...
サーバー
python inference_server.py --net isnet_is --ckpt isnetis.ckpt

''''''''''''''''''''''''''''''''''''

conda activate seg38
cd home/adachi/デスクトップ/anime-segmentation
python inference.py --net isnet_is --ckpt isnetis.ckpt --data image/ --out out --img-size 1024 --only-matted --device cuda

python inference_test.py --net isnet_is --ckpt isnetis.ckpt --data image/ --out out --img-size 1024 --only-matted --device cuda
サーバー
python inference_server.py --net isnet_is --ckpt isnetis.ckpt
'''''''''''''''''''''''''''''''''''''''''''''''''
tcp 側test
python bga_tcp.py  --test 1 --data image --out out
